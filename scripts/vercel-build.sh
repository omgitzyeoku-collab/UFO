#!/usr/bin/env bash
set -e
mkdir -p public/extract/text public/extract/public public/extract/thumbs public/docs
...
echo "vercel-build: $(find public/extract -type f | wc -l) extract files + $(ls public/extract/thumbs 2>/dev/null | wc -l) thumbs + $(ls public/docs 2>/dev/null | wc -l) docs"
